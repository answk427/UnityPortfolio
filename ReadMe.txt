포트폴리오 동영상 유투브 링크 주소 입니다.
https://youtu.be/JPCxGzwh2Xg


게임에 필요한 간단한 기능들을 4가지 부분으로 나누어 구현하였습니다.
1. Player
...
2. Enemy
 - EnemyAI : 코루틴함수를 통해 적 캐릭터의 현재 상태를 갱신, 상태에 따라 수행. 다른 스크립트에 명령을 내림. 순찰,추적,공격,사망 등
